...
(function(exports) {
  ...
  var real = function (cplx) {
      var $22 = Data_Complex.inCartesian(cplx);
      return $22.value0;
  };
  var powerset = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 69, column 1 - line 69, column 29: " + [ v.constructor.name ]);
  };
  ...
  var knapsackWeight = function ($61) {
  ...
  var retractSolution = function (n) {
      return function (optimal) {
          var solution = (function () {
              var $33 = knapsackValue(optimal) !== Data_Int.toNumber(n) / 2.0;
              if ($33) {
                  return Data_Maybe.Nothing.value;
              };
              if (!$33) {
              ...
              throw new Error("Failed pattern match at Main line 109, column 7 - line 111, column 62: " + [ $33.constructor.name ]);
          })();
          return solution;
      };
  };
  ...
  var imag = function (cplx) {
      var $36 = Data_Complex.inCartesian(cplx);
      return $36.value1;
  };
  ...
  var beta = function (epInstance) {
      ...
      throw new Error("Failed pattern match at Main line 91, column 19 - line 91, column 75: " + [ $58.constructor.name ]);
  };
  ...
  var render = function (items) {
      ...
      return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(ckpDrawing)(Graphics_Drawing.translate(200.0)(0.0)(columns));
  };
  var flare = (function () {
      ...
      return Data_Functor.map(Flare.functorUI)(function ($63) {
          return render(Data_Functor.map(Data_List_Types.functorList)(Data_Int.toNumber)($63));
