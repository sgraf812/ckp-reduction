...
(function(exports) {
  ...
  var powerset = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 68, column 1 - line 68, column 29: " + [ v.constructor.name ]);
  };
  ...
  var retractSolution = function (n) {
      return function (optimal) {
          var solution = (function () {
              ...
              throw new Error("Failed pattern match at Main line 108, column 7 - line 110, column 62: " + [ $33.constructor.name ]);
          })();
          return solution;
      };
  };
  ...
  var beta = function (epInstance) {
      ...
      throw new Error("Failed pattern match at Main line 90, column 19 - line 90, column 75: " + [ $58.constructor.name ]);
  };
  ...
  var render = function (items) {
      ...
      return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(ckpDrawing)(Graphics_Drawing.translate(200.0)(0.0)(Data_Monoid.mempty(Graphics_Drawing.monoidDrawing)));
  };
  var flare = (function () {
      var itemInput = new Data_List_Types.Cons(Flare["int"]("Item 1")(2), new Data_List_Types.Cons(Flare["int"]("Item 2")(2), new Data_List_Types.Cons(Flare["int"]("Item 3")(3), new Data_List_Types.Cons(Flare["int"]("Item 4")(4), new Data_List_Types.Cons(Flare["int"]("Item 5")(4), new Data_List_Types.Cons(Flare["int"]("Item 6")(5), Data_List_Types.Nil.value))))));
